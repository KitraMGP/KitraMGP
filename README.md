...
我正在研究桌面客户端开发的新技术（iced）和简单的游戏渲染应用（OpenGL/bgfx）。iced 是基于 Rust 的跨平台 UI 框架，可零配置直接交叉编译，可以实现美观界面并有着相对低的内存占用；bgfx 是一个跨平台渲染引擎，为 Vulkan 抽象出类似 OpenGL 的高级 API，并支持 Wayland。
